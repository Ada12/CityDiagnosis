...
window.console && console.log('--- Running highcharts.src.js from GitHub, branch/commit/tag "rambera" ---');window.console && console.warn('Warning: As of 2013-03-06 the Highcharts "rambera" branch is discontinued. Use "master" instead.');
